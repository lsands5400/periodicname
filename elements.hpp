 ...
 *
 * \brief Provides the interface definition for the Elements class which
 *        converts holds a map of periodic element symbols to names.
 *
 */

#ifndef ELEMENTS_HPP_INCLUDED
#define ELEMENTS_HPP_INCLUDED
...
/**
 * \class Elements
 * \brief Manages the periodic element representations
 *
 * \details
 * Includes map of periodic symbol keys to name values for storing arrays
 * of various aspects of the elements.
 *
 */
